...
public:
	...
	{
		cf_t<bf_t<u64, 0, 28>, ff_t<u64, 0, 4>> eal;
		cf_t<bf_t<u64, 28, 14>, ff_t<u64, 0, 4>> lsa;
		cf_t<bf_t<u64, 42, 12>, ff_t<u64, 0, 4>> size_plus_16;
		bf_t<u64, 54, 2> cmd_state;
		bf_t<u64, 56, 8> cmd_type;
	};

	std::shared_ptr<named_thread<mfc_thread>> mfc_thread;
