...
{
	/* exception causes */
	SYS_SPU_EXCEPTION_DMA_ALIGNMENT  = 0x0001ull,
	SYS_SPU_EXCEPTION_DMA_COMMAND    = 0x0002ull,
	SYS_SPU_EXCEPTION_SPU_ERROR      = 0x0004ull,
	SYS_SPU_EXCEPTION_MFC_FIR        = 0x0008ull,
	SYS_SPU_EXCEPTION_MFC_SEGMENT    = 0x0010ull,
	SYS_SPU_EXCEPTION_MFC_STORAGE    = 0x0020ull,
	SYS_SPU_EXCEPTION_STOP_CALL      = 0x0100ull,
	SYS_SPU_EXCEPTION_STOP_BREAK     = 0x0200ull,
	SYS_SPU_EXCEPTION_HALT           = 0x0400ull,
	SYS_SPU_EXCEPTION_UNKNOWN_SIGNAL = 0x0800ull,
	SYS_SPU_EXCEPTION_NON_CONTEXT    = 0x1000ull,
	SYS_SPU_EXCEPTION_MAT            = 0x2000ull,
	SYS_SPU_EXCEPTION_NO_VALUE       = 0x0000ull,
};
